...
ActiveRecord::Schema.define(:version => 20130725013553) do
  ...
  create_table "comments", :force => true do |t|
    ...
    t.string   "comment_image_remote_url"
    t.string   "tag"
  end

  create_table "comments2", :force => true do |t|
    t.integer  "author"
    t.string   "content"
    t.integer  "micropost_id"
    t.datetime "created_at",                 :null => false
  ...
  add_index "comments2", ["micropost_id"], :name => "index_comments_on_micropost_id"
  ...
  create_table "microposts", :force => true do |t|
    ...
    t.string   "post_image_remote_url_file_name"
    t.string   "post_image_remote_url_content_type"
    t.integer  "post_image_remote_url_file_size"
